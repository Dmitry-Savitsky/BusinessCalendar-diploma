        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ExecutorName = table.Column<string>(type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    ExecutorPhone = table.Column<string>(type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    Password = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RequiresAddress = table.Column<bool>(type: "tinyint(1)", nullable: false),
                    CompanyId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FromTime = table.Column<TimeOnly>(type: "time(6)", nullable: true),
                    TillTime = table.Column<TimeOnly>(type: "time(6)", nullable: true),
                    BreakStart = table.Column<TimeOnly>(type: "time(6)", nullable: true),
                    BreakEnd = table.Column<TimeOnly>(type: "time(6)", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ExecutorWorkTimes", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ExecutorWorkTimes_Executors_ExecutorId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ExecutorHasServices", x => new { x.ExecutorId, x.ServiceId });
                    table.ForeignKey(
                        name: "FK_ExecutorHasServices_Executors_ExecutorId",
                        column: x => x.ExecutorId,
                        principalTable: "Executors",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ExecutorHasServices_Services_ServiceId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("MySql:ValueGenerationStrategy", MySqlValueGenerationStrategy.IdentityColumn),
                    PublicId = table.Column<Guid>(type: "char(36)", nullable: false, collation: "ascii_general_ci"),
                    OrderComment = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    ClientId = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ServiceId = table.Column<int>(type: "int", nullable: false),
                    ExecutorId = table.Column<int>(type: "int", nullable: false),
                    ServiceStart = table.Column<DateTime>(type: "datetime(6)", nullable: true),
                    ServiceEnd = table.Column<DateTime>(type: "datetime(6)", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ServiceInOrders", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ServiceInOrders_Executors_ExecutorId",
                        column: x => x.ExecutorId,
                        principalTable: "Executors",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ServiceInOrders_Orders_OrderId",
                        column: x => x.OrderId,
                        principalTable: "Orders",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ServiceInOrders_Services_ServiceId",
                        column: x => x.ServiceId,
                        principalTable: "Services",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ExecutorHasServices_ServiceId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ExecutorWorkTimes_ExecutorId",
                table: "ExecutorWorkTimes",
                column: "ExecutorId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ServiceInOrders_ExecutorId",
                table: "ServiceInOrders",
                column: "ExecutorId");

            migrationBuilder.CreateIndex(
                name: "IX_ServiceInOrders_OrderId",
                table: "ServiceInOrders",
                column: "OrderId");

            migrationBuilder.CreateIndex(
                name: "IX_ServiceInOrders_ServiceId",
                table: "ServiceInOrders",
                column: "ServiceId");
